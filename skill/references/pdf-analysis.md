...
For scanned, mixed, encoded, damaged, or visually complex regions, use Codex visual reading from rendered pages. `pdftotext` is optional evidence for digital regions, never authoritative transcription and never OCR.
